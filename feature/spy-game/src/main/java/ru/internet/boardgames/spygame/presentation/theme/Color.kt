package ru.internet.boardgames.spygame.presentation.theme

import androidx.compose.ui.graphics.Color

// ─────────────────────────────────────────────────────────────────────────────
// Palette сгенерирована через Material Theme Builder (seed: #3949AB — Indigo)
// https://m3.material.io/theme-builder
// ─────────────────────────────────────────────────────────────────────────────

// ─── Light theme ─────────────────────────────────────────────────────────────

val md_theme_light_primary            = Color(0xFF3550C5)
val md_theme_light_onPrimary          = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer   = Color(0xFFDDE1FF)
val md_theme_light_onPrimaryContainer = Color(0xFF001061)
...
val md_theme_light_surfaceTint       = Color(0xFF3550C5)

// ─── Dark theme ──────────────────────────────────────────────────────────────

val md_theme_dark_primary            = Color(0xFFBAC3FF)
val md_theme_dark_onPrimary          = Color(0xFF01239D)
val md_theme_dark_primaryContainer   = Color(0xFF2339B1)
...
val md_theme_dark_tertiary            = Color(0xFFE9B9DA)
val md_theme_dark_onTertiary          = Color(0xFF46263F)
val md_theme_dark_tertiaryContainer   = Color(0xFF5D3C57)
...
val md_theme_dark_inversePrimary    = Color(0xFF3550C5)

val md_theme_dark_surfaceTint       = Color(0xFFBAC3FF)

// ─── Seed color (для справки) ─────────────────────────────────────────────
// Используется при тестировании без Dynamic Color
val seed = Color(0xFF3949AB)
